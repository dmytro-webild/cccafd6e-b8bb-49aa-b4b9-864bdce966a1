      ...
      bulletPoints={[
        {
          ...
          description: "We build and maintain trusted relationships with all partners.",
        },
        {
          title: "Daring to Differentiate",
          description: "We are market leaders who make bold decisions.",
        },
        {
  ...
  <div id="metrics" data-section="metrics">
      ...
      metrics={[
        ...
        },
        {
          id: "m3",
          value: "5+",
          description: "Expert Departments",
        },
      ]}
      ...
      faqs={[
        {
          ...
          content: "Yes, we handle ongoing maintenance for all electrical and security installations.",
        },
        {
          id: "f2",
          title: "What industries do you serve?",
          content: "We serve industrial, commercial, and residential clients with expert care.",
        },
        {
          id: "f3",
          title: "How do we book training?",
          content: "Contact us via the form or email to book your fire safety training session.",
        },
      ]}
      ...
      columns={[
        ...
        },
        {
          ...
          items: [
            {
              label: "Email",
              href: "mailto:throttlepoweholdings@gmail.com",
            },
            {
              label: "Call Us",
              href: "tel:+26776755001",
            },
          ],
        },
      ]}
